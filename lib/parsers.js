...
(function() {
  var debug, findModule, lazy, ok, parsers, text, _;
  ...
  text = function(x) {
    ...
    return x != null ? (_ref = x[0]) != null ? (_ref1 = _ref.children) != null ? (_ref2 = _ref1[0]) != null ? _ref2.data : void 0 : void 0 : void 0 : void 0;
  };
  ...
  parsers.page = function(o) {
    var averageInfo, averageViews, modules, number, subInfo, summary, totalSubscribers, totalViews, userInfo, viewInfo, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    debug("totalViews %s", lazy(function() {
      return parsers.number(totalViews);
    }));
    number = /-?[\d,]+/;
